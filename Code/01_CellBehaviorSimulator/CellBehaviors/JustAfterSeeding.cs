...
{
    public partial class JustAfterSeeding : UserControl
    {
        public JustAfterSeeding()
        {
            InitializeComponent();
        }
        ...
        #region ●細胞挙動パラメータ定義 Just after seeding
        ...
        public static bool ReadParameter(string strName, int typeNum, string strValue) // 20191017
        {
            // Just after seeding
            switch (strName)
            {
        ...
        public static bool SetParameter_alpha(int typeNum, string strVal)
        {
            ...
            //    flag = new List<bool>();
            //}
            //while (alpha.Count <= typeNum)
            //{
            //    alpha.Add(1);
            //    if (alpha.Count > flag.Count)
            //    {
            //        flag.Add(false);
            //    }
            //}
        ...
        public static bool SetParameter_tau_a(int typeNum, string strVal)
        {
            ...
            //    flag = new List<bool>();
            //}
            //while (tau_a.Count <= typeNum)
            //{
            //    tau_a.Add(0);
            //    if (tau_a.Count > flag.Count)
            //    {
            //        flag.Add(false);
            //    }
            //}
